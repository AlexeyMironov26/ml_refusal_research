...
- `artifacts/` — все сохранённые данные: вектор refusal direction, графики и прочее
- `test_refusal_ml_v7_fixed.ipynb` — ноутбук 
...
2. Импортировать `test_refusal_ml_v7_fixed.ipynb` и запустить.
